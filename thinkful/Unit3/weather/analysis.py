...
cities = ['atlanta', 'austin', 'boston', 'chicago', 'cleveland', 'denver', 'lasVegas', 'miami',
			'minneapolis', 'nashville', 'newOrleans', 'newYork', 'philadelphia', 'phoenix', 
			'saltLakeCity', 'sanFrancisco', 'seattle', 'washington']
...
# Calculate the highest temperature overall and where it was
temp_max_value = 0
temp_max_city = ''
for city in ranges:
...
# Convert the list in to a Series so that you can plot it
seattle_diff_series = pd.Series(seattle_diff) 
...
######################################################################################
# Plot a histogram of every city with temps rounded to the nearest degree Fahrenheit #
######################################################################################
