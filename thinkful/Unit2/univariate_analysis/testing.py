...
# Plot a bar graph of the data in Open.CREDIT.Lines as a frequency plot (count of the range of open credit lines on the y axis, and the range of open credit lines on the x-axis)
'''
plt.figure()
